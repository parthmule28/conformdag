...
| [C05](prompts/C05-deterministic-checks.md) | design/plan review | `docs/c05-deterministic-checks` | Docs revision `93c244d`; base `origin/main @ 3a651fe8b516b18fb8de2994e76c262635ce7482`; baseline `mise run check`: 539 passed, 2 skipped, 19 deselected; documentation tests: 11 passed; product code unchanged | Native/single-session execution and independent review are required; C05 architecture is accepted in principle, with `_version_tuple` assigned to safety and package/facade test sequencing corrected; implementation remains paused pending formal approval |
